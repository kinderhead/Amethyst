...
Supports data pack versions 88.0 (1.21.9) through 121.0 (26.3), theoretically works on Minecraft 1.20.5+ with some tweaks to the `pack.mcmeta` file. No, it will not be ported to 
earlier versions without macro functions.
