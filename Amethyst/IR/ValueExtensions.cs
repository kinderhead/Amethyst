	...
	public static class ValueExtensions
	{
		...
		extension(IValueLike self)
		{
			public T TypeOrRef<T>() where T : TypeSpecifier
			{
				...
				if (self.Type is ReferenceType ptr && ptr.Inner is T ret2)
				{
					return ret2;
				}
			...
			public bool IsTypeOrRef<T>() where T : TypeSpecifier =>
				self.Type is T || (self.Type is ReferenceType ptr && ptr.Inner is T);
