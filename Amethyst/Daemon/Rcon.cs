...
namespace Amethyst.Daemon
{
    ...
    public class Rcon : IDisposable
    {
        ...
        public Rcon(string url, int port)
        {
            ...
            if (!client.ConnectAsync(url, port).Wait(100)) throw new SocketException((int)SocketError.SocketError);
        ...
        public bool Login(string password) =>
            Send(new(password.Length + Message.HEADER_LENGTH, 1, MessageType.Login, password));

        public bool SendCommand(string cmd) =>
            Send(new(cmd.Length + Message.HEADER_LENGTH, 1, MessageType.Command, cmd));
...
#pragma warning restore CA2022
        ...
        public static int GetPort()
        {
            ...
            {
                if (i.StartsWith("rcon.port")) return int.Parse(i.Split('=')[1]);
            }
