...
namespace Amethyst.AST.Statements
{
        ...
        : Statement(loc)
    {
        ...
        public override void Compile(FunctionContext ctx)
        {
            ...
            if (BaseCall is CallExpression call && actualThisType is ReferenceType) call.Args.Insert(0, new VariableExpression(call.Location, "this"));

            if (BaseCall is not null) def = BaseCall?.Execute(ctx, null);
            ...
            if (actualThisType is ReferenceType)
            {
                ...
                {
                    var typeIDProp = ctx.Add(new PropertyInsn(self, new LiteralValue(StructType.TYPE_ID_PROPERTY),
