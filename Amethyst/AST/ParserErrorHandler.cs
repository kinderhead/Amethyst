...
{
	public class ParserErrorHandler(string path, string file, Visitor visitor)
		: BaseErrorListener, IAntlrErrorListener<int>, IFileHandler
	{
		...
		public void SyntaxError(TextWriter output, IRecognizer recognizer, int offendingSymbol, int line,
			...
			ThrowError(line, charPositionInLine, offendingSymbol, msg);
		...
		public override void SyntaxError(TextWriter output, IRecognizer recognizer, IToken offendingSymbol, int line,
			int charPositionInLine, string msg, RecognitionException e) =>
			ThrowError(line, charPositionInLine, offendingSymbol.Text.Length, msg);
