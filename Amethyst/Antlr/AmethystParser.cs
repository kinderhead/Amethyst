...
public partial class AmethystParser : Parser {
	...
	public BlockContext block() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1142929183912757212L) != 0)) {
				{
				{
				State = 133;
				statement();
	...
	private static int[] _serializedATN = {
		...
		0,11,13,1,0,18,19,1,0,2,4,1,0,8,9,2,0,29,29,36,39,1,0,48,49,1,0,41,42,
		1,0,43,46,1,0,30,31,1,0,32,34,5,0,31,32,35,35,47,47,50,51,54,54,513,0,
		...
		128,5,40,0,0,128,129,3,90,45,0,129,7,1,0,0,0,130,131,5,16,0,0,131,9,1,
		...
		0,158,161,5,55,0,0,159,160,5,29,0,0,160,162,3,38,19,0,161,159,1,0,0,0,
		...
		174,1,0,0,0,173,171,1,0,0,0,174,175,3,86,43,0,175,176,5,55,0,0,176,177,
		...
		182,1,0,0,0,185,186,5,55,0,0,186,189,3,78,39,0,187,188,5,21,0,0,188,190,
		...
		23,1,0,0,0,228,229,3,38,19,0,229,25,1,0,0,0,230,231,5,57,0,0,231,27,1,
