...
namespace Datapack.Net.SourceGenerator
{
	public static class Utils
	{
		public static string GenerateWrapper(MCFunction func, bool self = false)
		{
			...
			if (func.Macro)
			{
				args.Add("System.Collections.Generic.KeyValuePair<string, object>[] macros");
			}

			if (func.ReturnType != "void")
			{
				args.Add($"{func.ReturnType} ret");
			}
		...
		{
			if (type == "Datapack.Net.Data.NBTString")
			{
				return "Datapack.Net.CubeLib.StringRuntimeProperty";
			}

			if (type == "Datapack.Net.Data.NBTInt")
			{
				return "Datapack.Net.CubeLib.IntRuntimeProperty";
			}

			if (type == "Datapack.Net.Data.NBTLong")
			{
				return "Datapack.Net.CubeLib.LongRuntimeProperty";
			}

			if (type == "Datapack.Net.Data.NBTShort")
			{
				return "Datapack.Net.CubeLib.ShortRuntimeProperty";
			}

			if (type == "Datapack.Net.Data.NBTFloat")
			{
				return "Datapack.Net.CubeLib.FloatRuntimeProperty";
			}

			if (type == "Datapack.Net.Data.NBTDouble")
			{
				return "Datapack.Net.CubeLib.DoubleRuntimeProperty";
			}

			if (type == "Datapack.Net.Data.NBTByte")
			{
				return "Datapack.Net.CubeLib.ByteRuntimeProperty";
			}

			if (type == "Datapack.Net.Data.NBTBool")
			{
				return "Datapack.Net.CubeLib.BoolRuntimeProperty";
			}
