...
Datapack.Net still has a long way to go, so feel free to play around and catch bugs. I might notice when bug reports are
made.
...
* Supports 1.20.4
    * 1.20.5+ support is limited due to the new item components replacing NBT. Most things should still work. This will
...
Datapack.Net can be installed via NuGet [here](https://www.nuget.org/packages/Datapack.Net/). The CubeLib (deprecated)
analyzer is a separate package located [here](https://www.nuget.org/packages/Datapack.Net.SourceGenerator).
