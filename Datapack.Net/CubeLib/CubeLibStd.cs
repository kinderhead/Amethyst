...
namespace Datapack.Net.CubeLib
{
    public partial class CubeLibStd(DP pack) : Project(pack)
    {
        ...
        public void _StorageExistsConcat()
        {
        ...
        public void _PointerDereference()
        {
            var x = Local();
