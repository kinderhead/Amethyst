...
namespace Datapack.Net.CubeLib
{
	...
	public class DeclareMCAttribute : Attribute
	{
		...
		public static DeclareMCAttribute Get(Delegate func) => Get(func.Method);

		public static DeclareMCAttribute Get(MethodInfo func) => func.GetCustomAttribute<DeclareMCAttribute>() ?? throw new InvalidOperationException("Function does not have the DeclareMC attribute");
		...
		public static Type[] Args(Delegate func)
		{
			...
			{
				if (i.ParameterType.GetInterface(nameof(IRuntimeArgument)) != null)
				{
					types.Add(i.ParameterType);
				}
				else
				{
					throw new InvalidOperationException($"Function {func.Method.Name} is not a valid Minecraft function");
				}
			}
