...
namespace Datapack.Net.CubeLib
{
	public class MacroPointer<T>(string storage, string path, string pointer, string ext) : IPointer<T> where T : IPointerable
	{
		...
		public IPointer<R> Get<R>(string path, bool dot = true) where R : IPointerable => throw new NotImplementedException();

		public ScoreRef GetAsArg() => throw new NotImplementedException();

		public BaseHeapPointer GetHeapPointer() => throw new NotImplementedException();

		public IPointer<T> Local() => throw new NotImplementedException();

		public void Move(IPointer<T> dest) => throw new NotImplementedException();

		public void MoveUnsafe(IStandardPointerMacros dest) => throw new NotImplementedException();

		public void Set(NBTValue val) => throw new NotImplementedException();

		public void Set(ScoreRef val) => throw new NotImplementedException();

		public KeyValuePair<string, object>[] StandardMacros(KeyValuePair<string, object>[]? extras = null, string postfix = "") => throw new NotImplementedException();

		public IPointer ToPointer() => throw new NotImplementedException();

		public RuntimePointer<T> ToRTP() => throw new NotImplementedException();

		public RuntimePointer<R> ToRTP<R>() where R : IPointerable => throw new NotImplementedException();

		public RuntimePointer<R> ToRTP<R>(RuntimePointer<R> ptr) where R : IPointerable => throw new NotImplementedException();
	}
}
