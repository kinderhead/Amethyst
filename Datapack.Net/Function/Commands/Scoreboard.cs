	...
	public static class Scoreboard
	{
		public static class Objectives
		{
			public class Add(Score score, bool macro = false) : Command(macro)
			{
				...
				protected override string PreBuild() =>
					$"scoreboard objectives add {Score} {Score.Criteria} {Score.DisplayName}";
			}
		...
		public static class Players
		{
			...
			public class Reset(IEntityTarget target, Score? score = null, bool macro = false) : Command(macro)
			{
				...
				protected override string PreBuild() =>
					$"scoreboard players reset {Target.Get()} {(Score == null ? "" : Score)}";
			}
			...
			public class Operation(
				...
				Score targetScore,
				ScoreOperation op,
				IEntityTarget source,
				Score sourceScore,
				bool macro = false) : Command(macro)
			{
				...
				protected override string PreBuild() =>
					$"scoreboard players operation {Target.Get()} {TargetScore} {FromOperation(Op)} {Source.Get()} {SourceScore}";
			}
		}
	}
