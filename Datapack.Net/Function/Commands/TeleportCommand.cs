...
namespace Datapack.Net.Function.Commands
{
    public class TeleportCommand : Command
    {
        ...
        {
            if (Destination is not null && Target is null && Location is null && Rotation is null && FacingLocation is null && FacingEntity is null) return $"tp {Destination.Get()}";
            if (Target is not null && Destination is not null && FacingLocation is null && FacingEntity is null) return $"tp {Target.Get()} {Destination.Get()}";
            if (Destination is null && Target is null && Location is not null && Rotation is null && FacingLocation is null && FacingEntity is null) return $"tp {Location}";
            if (Target is not null && Location is not null && Rotation is null && FacingLocation is null && FacingEntity is null) return $"tp {Target.Get()} {Location}";
            if (Target is not null && Location is not null && Rotation is not null && FacingLocation is null && FacingEntity is null) return $"tp {Target.Get()} {Location} {Rotation}";
            if (Target is not null && Location is not null && Rotation is null && FacingLocation is not null && FacingEntity is null) return $"tp {Target.Get()} {Location} facing {FacingLocation}";
            if (Target is not null && Location is not null && Rotation is null && FacingLocation is null && FacingEntity is not null) return $"tp {Target.Get()} {Location} facing entity {FacingEntity.Get()} {(Eyes ? "eyes" : "feet")}";
