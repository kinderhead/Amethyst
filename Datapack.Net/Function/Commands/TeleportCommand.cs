namespace Datapack.Net.Function.Commands
{
	public class TeleportCommand : Command
	{
		...
		public TeleportCommand(IEntityTarget target, Position location, Rotation rotation, bool macro = false) :
			base(macro)
		{
			Target = target;
			Location = location;
		...
		public TeleportCommand(IEntityTarget target, Position location, Position facingLocation, bool macro = false) :
			base(macro)
		{
			Target = target;
			Location = location;
		...
		public TeleportCommand(IEntityTarget target, Position location, IEntityTarget facingEntity, bool eyes = false,
		...
		{
			if (Destination is not null && Target is null && Location is null && Rotation is null &&
			    FacingLocation is null && FacingEntity is null)
			{
			...
			if (Destination is null && Target is null && Location is not null && Rotation is null &&
			    FacingLocation is null && FacingEntity is null)
			{
				return $"tp {Location}";
			}

			if (Target is not null && Location is not null && Rotation is null && FacingLocation is null &&
			    FacingEntity is null)
			{
				return $"tp {Target.Get()} {Location}";
			}

			if (Target is not null && Location is not null && Rotation is not null && FacingLocation is null &&
			    FacingEntity is null)
			{
				return $"tp {Target.Get()} {Location} {Rotation}";
			}

			if (Target is not null && Location is not null && Rotation is null && FacingLocation is not null &&
			    FacingEntity is null)
			{
