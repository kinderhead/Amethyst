...
const config: Config = {
    title: 'Amethyst',
    tagline: 'Programming language for Minecraft data packs',
    ...
    organizationName: 'kinderhead', // Usually your GitHub org/user name.
    projectName: 'Amethyst', // Usually your repo name.
    trailingSlash: true,
    ...
    themeConfig: {
        ...
        items: [
            ...
            {
                href: 'https://github.com/kinderhead/Amethyst',
                label: 'GitHub',
                position: 'right',
            },
            {
                href: 'https://discord.gg/TTmZSHgSSq',
                label: 'Discord',
                position: 'right',
            },
        ],
