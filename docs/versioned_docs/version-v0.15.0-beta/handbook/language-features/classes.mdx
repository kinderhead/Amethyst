...
* Entity properties
* Maps
  * This may change in the future if a reliable way to iterate over NBT object keys is found. Feel free to create an [issue](https://github.com/kinderhead/Amethyst/issues) if you know of one.
